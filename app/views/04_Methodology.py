...
section_head("Pipeline", "Eight stages, in order")
...
section_head("Locks", "Temporal integrity")
meta_rail([
...
insight_panel(
    ...
    "<code>v1.0-evidence-freeze</code>, thesis-verified on every page load.",
    header="FROZEN EVIDENCE", tone="frozen",
)
insight_panel(
    "<b>Interactive analysis</b> (blue) derives from <code>app_data/</code> small extracts "
    "and is labeled on every module it produces. One never overwrites the other.",
    header="INTERACTIVE ANALYSIS", tone="live",
)

st.caption(
    "Protocol provenance: docs/research/experiment-protocol.md is the study's v1.0 experiment constitution "
    ...
    "validation, and feasibility — recorded in 00_project/decisions.md."
)
ok = F.verify_thesis()
